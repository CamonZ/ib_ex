defmodule IbEx.Client.Proto.Mapper.Order do
  ...
  def to_proto(%DomainOrder{} = order) do
    %ProtoOrder{
      ...
      trigger_price: Helpers.sentinel_double_to_proto(order.trigger_price),
      adjusted_stop_price: Helpers.sentinel_double_to_proto(order.adjusted_stop_price),
      adjusted_stop_limit_price: Helpers.sentinel_double_to_proto(order.adjusted_stop_limit_price),
      adjusted_trailing_amount: Helpers.sentinel_double_to_proto(order.adjusted_trailing_amount),
      adjustable_trailing_unit: order.adjustable_trailing_unit,
      lmt_price_offset: Helpers.sentinel_double_to_proto(order.limit_price_offset),
      ...
      cash_qty: Helpers.sentinel_double_to_proto(order.cash_quantity),
      ...
      duration: Helpers.sentinel_int_to_proto(order.duration),
      post_to_ats: Helpers.sentinel_int_to_proto(order.post_to_ats),
      ...
      manual_order_indicator: Helpers.sentinel_int_to_proto(order.manual_order_indicator),
  ...
  def from_proto(%ProtoOrder{} = proto) do
    DomainOrder.new(%{
      ...
      trigger_price: Helpers.proto_to_sentinel_double(proto.trigger_price),
      adjusted_stop_price: Helpers.proto_to_sentinel_double(proto.adjusted_stop_price),
      adjusted_stop_limit_price: Helpers.proto_to_sentinel_double(proto.adjusted_stop_limit_price),
      adjusted_trailing_amount: Helpers.proto_to_sentinel_double(proto.adjusted_trailing_amount),
      adjustable_trailing_unit: proto.adjustable_trailing_unit || 0,
      limit_price_offset: Helpers.proto_to_sentinel_double(proto.lmt_price_offset),
      ext_operator: proto.ext_operator,
      cash_quantity: Helpers.proto_to_sentinel_double(proto.cash_qty),
      ...
      duration: Helpers.proto_to_sentinel_int(proto.duration),
      post_to_ats: Helpers.proto_to_sentinel_int(proto.post_to_ats),
      ...
      manual_order_indicator: Helpers.proto_to_sentinel_int(proto.manual_order_indicator),
