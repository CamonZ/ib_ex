defmodule IbEx.Client.Messages.Responses do
  ...
  @ids_to_message_type %{
    "1" => Messages.MarketData.Tick.Price,
    "2" => Messages.MarketData.Tick.Size,
    ...
    "20" => "scanner_data",
    "21" => Messages.MarketData.Tick.OptionComputation,
    "45" => Messages.MarketData.Tick.Generic,
    "46" => Messages.MarketData.Tick.String,
    "47" => "tick_efp",
    ...
    "81" => Messages.MarketData.Tick.RequestParams,
    "82" => "smart_components",
    "83" => Messages.News.ArticleData,
    "84" => Messages.MarketData.Tick.News,
