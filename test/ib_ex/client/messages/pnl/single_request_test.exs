defmodule IbEx.Client.Messages.Pnl.SingleRequestTest do
  use ExUnit.Case

  alias IbEx.Client.Messages.Pnl.SingleRequest
  ...
  describe "new/4" do
    test "creates a SingleRequest struct with valid inputs" do
      assert {:ok, msg} = SingleRequest.new(@request_id, @account_id, @apple_conid)
