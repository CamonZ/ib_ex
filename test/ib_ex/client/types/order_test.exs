  ...
  describe "new/1" do
    test "creates an Order with valid attributes" do
      ...
      assert Order.new(params) == %Order{
               ...
               delta_neutral_params: DeltaNeutralParams.new(),
  ...
  describe "serialize/1" do
    ...
    test "serializes second batch of parameters for RequestCreateOrder" do
      ...
      assert Order.new(params) |> Order.serialize(:second_batch) == [
               ...
               params.delta_neutral_params.order_type,
               params.delta_neutral_params.aux_price,
               params.delta_neutral_params.conid,
               params.delta_neutral_params.settling_firm,
               params.delta_neutral_params.clearing_account,
               params.delta_neutral_params.clearing_intent,
               params.delta_neutral_params.open_close,
               params.delta_neutral_params.short_sale,
               params.delta_neutral_params.short_sale_slot,
               params.delta_neutral_params.designated_location,
